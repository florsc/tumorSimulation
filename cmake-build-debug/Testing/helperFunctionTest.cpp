...
TEST(Test, sphericalCoordinateFunctionBasic) {
    EXPECT_EQ(HelperFunctions::sph2cart(0,0,1), SpatialVector({1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(0,M_PI,1), SpatialVector({-1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(M_PI,0,1), SpatialVector({-1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(0,2*M_PI,1), SpatialVector({1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(2*M_PI,0,1), SpatialVector({1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(0,M_PI/2,1), SpatialVector({0,0,1}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(M_PI/2,0,1), SpatialVector({0,1,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(0,-M_PI,1), SpatialVector({-1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(-M_PI,0,1), SpatialVector({-1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(0,-2*M_PI,1), SpatialVector({1,0,0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(-2*M_PI,0,1), SpatialVector({1,0,0}));
...
TEST(Test, sphericalCoordinateFunctionComplex) {
    checkDoubleVectorEquality(HelperFunctions::sph2cart(M_PI, M_PI, 1), SpatialVector({1, 0, 0}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(M_PI / 4, 0, 1), SpatialVector({sqrt(0.5), sqrt(0.5), 0}));
...
TEST(Test, sphericalCoordinateTestValues) {
    checkDoubleVectorEquality(HelperFunctions::sph2cart( 0.92729,0.78539, 7.07106),
                              SpatialVector({3, 4, 5}));
    checkDoubleVectorEquality(HelperFunctions::sph2cart(  0.16162,0.38709, 10.06628),
