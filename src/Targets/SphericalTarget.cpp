...
SphericalTarget::SphericalTarget(SphericalTargetSetUpParametersHandle sphericalTargetSetUpParameters)
        : m_centerPoint(sphericalTargetSetUpParameters->centerPoint), m_radius(sphericalTargetSetUpParameters->radius),m_gravityConstant(sphericalTargetSetUpParameters->gravityConstant), m_mass(sphericalTargetSetUpParameters->radius*sphericalTargetSetUpParameters->radius*sphericalTargetSetUpParameters->radius*M_PI) {}
